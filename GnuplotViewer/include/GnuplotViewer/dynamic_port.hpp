 ...
 * @return 0 if no error, 2 if allocation error
 */
template <class DataType> 
...
/*!
 * @brief Add new port
 * @return 0 if no error, 2 if allocation error, 3 error in m_data.addData(), 4 error in m_port.addInPort()
 */
template <class DataType> 
 ...
 * @return 0 if no error, 1 if invalid index, 2 if allocation error
 */
template <class DataType> 
...
/*!
 * @brief Add new port
 * @return 0 if no error, 2 if allocation error, 3 error in m_data.addData(), 4 error in m_port.addOutPort()
 */
template <class DataType> 
