...
#ifndef SINCOSFUNCTION_H
#define SINCOSFUNCTION_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  SinCosFunction(RTC::Manager* manager);

  /*!
   * @brief destructor
   */
  ~SinCosFunction() override;
 ...
 protected:
   ...
   * - Number: 3*SampleNum
   */
  RTC::OutPort<RTC::TimedDoubleSeq> m_XSinCosDataOut;
 ...
 private:
  // <rtc-template block="private_attribute">
	std::chrono::system_clock::time_point t0; //for time measurement
  // </rtc-template>
...
extern "C"
{
  DLL_EXPORT void SinCosFunctionInit(RTC::Manager* manager);
};

#endif // SINCOSFUNCTION_H
